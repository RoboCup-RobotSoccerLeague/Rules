...
\begin{enumerate}
    ...
    Sensors aiming to directly emulate human senses like camera, microphone. Use o such sensors is explicitly \emph{encouraged}.
    ...
    Sensors that compensate for current shortcomings in technology and state of the research like one dimensional distance sensors with limited range or two vertical cameras in the robot NAO.
\end{enumerate}
...
Any sensing capability aiming at measuring internal state of the robot are permitted. 
...
The cameras are restricted to visual information in range of the light visible to humans.
...
Passive integrated devises that provide dence depths information, such as stereo cameras, are permitted and encouraged.

Active integrated devises that provide depths information, such as cameras with active infrared projector or time of flight cameras, are permitted, but discouraged.
Their use might be prohibited in the future.


\subsubsection{Orientation}

Sensors providing information regarding robot's orientation in space with relation to the ground are permitted. This includes such sensory like gyro, accelerometer as well as integrated inertial measurement units (IMU) as long as they provide only relative measurements and no measurements of the absolute direction such as a compas.

An IMU with an integrated compas can be used as long as the compas is disabled.
...
The number of the microphones is limited to ??
...
Active and passive sensors for one dimensional distance sensing with limited range are permitted as long as they compensate for shortcomings in the spatial awareness of the robot in the close proximity.
