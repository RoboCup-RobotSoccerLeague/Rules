...
The field surface and related elements should follow these color guidelines:
\begin{itemize}
    \item Field surface: The playing surface (artificial turf) should be green. No particular shade is required, but the green must contrast well with the field markings and the ball and should not be very dark.
    \item Field markings: All boundary and field lines should be white, whether applied by tape, paint, or made from white turf.
    \item Goal frame and netting: Goalposts and the crossbar should be white. Goal nets and any net supports may be white, gray, or black.
\end{itemize}
